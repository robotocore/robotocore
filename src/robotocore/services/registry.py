...
SERVICE_REGISTRY: dict[str, ServiceInfo] = {
    ...
    "acmpca": ServiceInfo(
        "acmpca", ServiceStatus.MOTO_BACKED, "json", "ACM Private CA"
    ),
    "amp": ServiceInfo(
        "amp", ServiceStatus.MOTO_BACKED, "rest-json", "Managed Prometheus"
    ),
    "apigatewaymanagementapi": ServiceInfo(
        "apigatewaymanagementapi", ServiceStatus.MOTO_BACKED, "rest-json",
        "API Gateway Management API",
    ),
    "appconfig": ServiceInfo(
        "appconfig", ServiceStatus.MOTO_BACKED, "rest-json", "AppConfig"
    ),
    "applicationautoscaling": ServiceInfo(
        "applicationautoscaling", ServiceStatus.MOTO_BACKED, "json", "Application Auto Scaling"
    ),
    "appmesh": ServiceInfo(
        "appmesh", ServiceStatus.MOTO_BACKED, "rest-json", "App Mesh"
    ),
    "athena": ServiceInfo(
        "athena", ServiceStatus.MOTO_BACKED, "json", "Athena SQL Analytics"
    ),
    "autoscaling": ServiceInfo(
        "autoscaling", ServiceStatus.MOTO_BACKED, "query", "Auto Scaling Groups"
    ),
    "backup": ServiceInfo(
        "backup", ServiceStatus.MOTO_BACKED, "rest-json", "AWS Backup"
    ),
    "bedrock": ServiceInfo(
        "bedrock", ServiceStatus.MOTO_BACKED, "rest-json", "Bedrock AI"
    ),
    "bedrockagent": ServiceInfo(
        "bedrockagent", ServiceStatus.MOTO_BACKED, "rest-json", "Bedrock Agent"
    ),
    "budgets": ServiceInfo(
        "budgets", ServiceStatus.MOTO_BACKED, "json", "AWS Budgets"
    ),
    "ce": ServiceInfo(
        "ce", ServiceStatus.MOTO_BACKED, "json", "Cost Explorer"
    ),
    ...
    "cloudhsmv2": ServiceInfo(
        "cloudhsmv2", ServiceStatus.MOTO_BACKED, "json", "CloudHSM v2"
    ),
    "cloudtrail": ServiceInfo(
        "cloudtrail", ServiceStatus.MOTO_BACKED, "json", "CloudTrail Audit Logging"
    ),
    "codebuild": ServiceInfo(
        "codebuild", ServiceStatus.MOTO_BACKED, "json", "CodeBuild CI"
    ),
    ...
    "comprehend": ServiceInfo(
        "comprehend", ServiceStatus.MOTO_BACKED, "json", "Comprehend NLP"
    ),
    "connect": ServiceInfo(
        "connect", ServiceStatus.MOTO_BACKED, "rest-json", "Amazon Connect"
    ),
    "connectcampaigns": ServiceInfo(
        "connectcampaigns", ServiceStatus.MOTO_BACKED, "rest-json", "Connect Campaigns"
    ),
    "databrew": ServiceInfo(
        "databrew", ServiceStatus.MOTO_BACKED, "rest-json", "DataBrew"
    ),
    "datapipeline": ServiceInfo(
        "datapipeline", ServiceStatus.MOTO_BACKED, "json", "Data Pipeline"
    ),
    "datasync": ServiceInfo(
        "datasync", ServiceStatus.MOTO_BACKED, "json", "DataSync"
    ),
    "dax": ServiceInfo(
    ...
    "ds": ServiceInfo(
        "ds", ServiceStatus.MOTO_BACKED, "json", "Directory Service"
    ),
    "dsql": ServiceInfo(
    ...
    "efs": ServiceInfo(
        "efs", ServiceStatus.MOTO_BACKED, "rest-json", "Elastic File System"
    ),
    "eks": ServiceInfo(
        "eks", ServiceStatus.MOTO_BACKED, "rest-json", "Elastic Kubernetes Service"
    ),
    ...
    "elb": ServiceInfo(
        "elb", ServiceStatus.MOTO_BACKED, "query", "Classic Load Balancer"
    ),
    "elbv2": ServiceInfo(
        "elbv2", ServiceStatus.MOTO_BACKED, "query", "Application/Network Load Balancer"
    ),
    "emr": ServiceInfo(
        "emr", ServiceStatus.MOTO_BACKED, "json", "Elastic MapReduce"
    ),
    ...
    "glue": ServiceInfo(
        "glue", ServiceStatus.MOTO_BACKED, "json", "Glue ETL"
    ),
    ...
    "iot": ServiceInfo(
        "iot", ServiceStatus.MOTO_BACKED, "rest-json", "IoT Core"
    ),
    "iotdata": ServiceInfo(
        "iotdata", ServiceStatus.MOTO_BACKED, "rest-json", "IoT Data Plane"
    ),
    "ivs": ServiceInfo(
        "ivs", ServiceStatus.MOTO_BACKED, "rest-json", "Interactive Video Service"
    ),
    "kafka": ServiceInfo(
    ...
    "macie2": ServiceInfo(
        "macie2", ServiceStatus.MOTO_BACKED, "rest-json", "Macie v2"
    ),
    ...
    "medialive": ServiceInfo(
        "medialive", ServiceStatus.MOTO_BACKED, "rest-json", "MediaLive"
    ),
    ...
    "osis": ServiceInfo(
        "osis", ServiceStatus.MOTO_BACKED, "rest-json", "OpenSearch Ingestion"
    ),
    ...
    "pipes": ServiceInfo(
        "pipes", ServiceStatus.MOTO_BACKED, "rest-json", "EventBridge Pipes"
    ),
    "polly": ServiceInfo(
        "polly", ServiceStatus.MOTO_BACKED, "rest-json", "Polly Text-to-Speech"
    ),
    "quicksight": ServiceInfo(
        "quicksight", ServiceStatus.MOTO_BACKED, "rest-json", "QuickSight"
    ),
    "ram": ServiceInfo(
        "ram", ServiceStatus.MOTO_BACKED, "rest-json", "Resource Access Manager"
    ),
    "rds": ServiceInfo(
        "rds", ServiceStatus.MOTO_BACKED, "query", "Relational Database Service"
    ),
    "rdsdata": ServiceInfo(
        "rdsdata", ServiceStatus.MOTO_BACKED, "rest-json", "RDS Data API"
    ),
    ...
    "s3tables": ServiceInfo(
        "s3tables", ServiceStatus.MOTO_BACKED, "rest-json", "S3 Tables"
    ),
    "s3vectors": ServiceInfo(
        "s3vectors", ServiceStatus.MOTO_BACKED, "rest-json", "S3 Vectors"
    ),
    ...
    "servicecatalogappregistry": ServiceInfo(
        "servicecatalogappregistry", ServiceStatus.MOTO_BACKED, "rest-json",
    ...
    "signer": ServiceInfo(
        "signer", ServiceStatus.MOTO_BACKED, "rest-json", "Signer"
    ),
    "ssoadmin": ServiceInfo(
        "ssoadmin", ServiceStatus.MOTO_BACKED, "json", "SSO Admin"
    ),
    "synthetics": ServiceInfo(
        "synthetics", ServiceStatus.MOTO_BACKED, "rest-json", "CloudWatch Synthetics"
    ),
    "textract": ServiceInfo(
        "textract", ServiceStatus.MOTO_BACKED, "json", "Textract"
    ),
    ...
    "transfer": ServiceInfo(
        "transfer", ServiceStatus.MOTO_BACKED, "json", "Transfer Family"
    ),
    "vpclattice": ServiceInfo(
        "vpclattice", ServiceStatus.MOTO_BACKED, "rest-json", "VPC Lattice"
    ),
    "wafv2": ServiceInfo(
        "wafv2", ServiceStatus.MOTO_BACKED, "json", "WAF v2"
    ),
    "workspaces": ServiceInfo(
        "workspaces", ServiceStatus.MOTO_BACKED, "json", "WorkSpaces"
    ),

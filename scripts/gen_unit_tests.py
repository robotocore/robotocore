...
def generate_test_content(src_rel: str, signatures: list[dict]) -> str:
    ...
    _module_name = module_import.split(".")[-1]
    ...
    for sig in signatures:
        if sig["type"] == "function":
            ...
            if sig["args"]:
                ...
                _args_str = ", ".join(f"{a}=None" for a in sig["args"])
                if sig["is_async"]:
                    lines.append("        # TODO: async test")
                    lines.append("        pass")
                else:
                    lines.append("        # TODO: implement with real arguments")
                    lines.append("        pass")
                lines.append("")
            ...
            if not sig["methods"]:
                ...
                lines.append("        # TODO: test instantiation")
                lines.append("        pass")
                lines.append("")
            else:
                for method in sig["methods"]:
                    ...
                    if mname == "__init__":
                        ...
                        lines.append("        # TODO: test with real arguments")
                        lines.append("        pass")
                    else:

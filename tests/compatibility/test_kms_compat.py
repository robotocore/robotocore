...
class TestKmsAutoCoverage:
    """Auto-generated coverage tests for kms."""

    @pytest.fixture
    def client(self):
        return make_client("kms")

    def test_connect_custom_key_store(self, client):
        """ConnectCustomKeyStore is implemented (may need params)."""
        try:
    ...
    def test_create_custom_key_store(self, client):
        """CreateCustomKeyStore is implemented (may need params)."""
        try:
    ...
    def test_delete_custom_key_store(self, client):
        """DeleteCustomKeyStore is implemented (may need params)."""
        try:
    ...
    def test_delete_imported_key_material(self, client):
        """DeleteImportedKeyMaterial is implemented (may need params)."""
        try:
    ...
    def test_derive_shared_secret(self, client):
        """DeriveSharedSecret is implemented (may need params)."""
        try:
    ...
    def test_disconnect_custom_key_store(self, client):
        """DisconnectCustomKeyStore is implemented (may need params)."""
        try:
    ...
    def test_generate_data_key_pair(self, client):
        """GenerateDataKeyPair is implemented (may need params)."""
        try:
    ...
    def test_generate_data_key_pair_without_plaintext(self, client):
        """GenerateDataKeyPairWithoutPlaintext is implemented (may need params)."""
        try:
    ...
    def test_get_parameters_for_import(self, client):
        """GetParametersForImport is implemented (may need params)."""
        try:
    ...
    def test_import_key_material(self, client):
        """ImportKeyMaterial is implemented (may need params)."""
        try:
    ...
    def test_list_key_rotations(self, client):
        """ListKeyRotations is implemented (may need params)."""
        try:
    ...
    def test_replicate_key(self, client):
        """ReplicateKey is implemented (may need params)."""
        try:
    ...
    def test_rotate_key_on_demand(self, client):
        """RotateKeyOnDemand is implemented (may need params)."""
        try:
    ...
    def test_update_custom_key_store(self, client):
        """UpdateCustomKeyStore is implemented (may need params)."""
        try:
    ...
    def test_update_primary_region(self, client):
        """UpdatePrimaryRegion is implemented (may need params)."""
        try:

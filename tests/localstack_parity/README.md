...
|---|---|---|---|
| `test_notes_app.py` | API Gateway + Lambda + DynamoDB | REST API CRUD | [note_taking scenario](../../vendor/localstack/tests/aws/scenario/note_taking/) |
...
| `test_dynamodb_streams.py` | DynamoDB Streams + Lambda + DynamoDB | Stream -> Lambda ESM | [bookstore scenario](../../vendor/localstack/tests/aws/scenario/bookstore/) |
| `test_kinesis_lambda.py` | Kinesis + Lambda + DynamoDB | Stream -> Lambda ESM | [kinesis_firehose scenario](../../vendor/localstack/tests/aws/scenario/kinesis_firehose/) |

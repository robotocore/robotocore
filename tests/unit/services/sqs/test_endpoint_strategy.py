...
class TestParseSqsUrl:
    ...
    def test_standard_host_parsing_robotocore(self):
    ...
    def test_standard_host_parsing_localstack_alias(self):
    ...
    def test_domain_host_parsing_robotocore(self):
        result = parse_sqs_url(
            "/123456789012/my-queue",
    ...
    def test_domain_host_parsing_localstack_alias(self):
        """localstack.cloud is accepted as a backward-compat alias."""
        result = parse_sqs_url(
            "/123456789012/my-queue",

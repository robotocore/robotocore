...
class TestSqsDomainStyleRouting:
    ...
    def test_standard_host_routes_to_sqs_robotocore(self):
    ...
    def test_standard_host_routes_to_sqs_localstack_alias(self):
        """localstack.cloud is accepted as a backward-compat alias."""
        result = parse_sqs_url(
            "/123456789012/my-queue",
    ...
    def test_domain_host_routes_to_sqs_robotocore(self):
        result = parse_sqs_url(
            "/123456789012/my-queue",
    ...
    def test_domain_host_routes_to_sqs_localstack_alias(self):
        """localstack.cloud is accepted as a backward-compat alias."""
        result = parse_sqs_url(
            "/123456789012/my-queue",
...
class TestOpenSearchDomainStyleRouting:
    ...
    def test_domain_host_routes_to_opensearch_robotocore(self):
    ...
    def test_domain_host_routes_to_opensearch_localstack_alias(self):
        """localstack.cloud is accepted as a backward-compat alias."""
        result = parse_opensearch_url(
            "/",

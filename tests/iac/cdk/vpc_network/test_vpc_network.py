...
def vpc_resources(ec2_client):
    ...
    ec2_client.create_tags(Resources=[subnet_a_id], Tags=[{"Key": "Name", "Value": "subnet-a"}])
    ...
    ec2_client.create_tags(Resources=[subnet_b_id], Tags=[{"Key": "Name", "Value": "subnet-b"}])
...
class TestVpcNetwork:
    """CDK VPC network: VPC + 2 subnets + security group."""
